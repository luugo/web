...
const PageLogin: FC = async () => {
    ...
    categories.sort((a: any, b: any) => CATEGORY[a.id].title.localeCompare(CATEGORY[b.id].title));
    subcategories.sort((a: any, b: any) => CATEGORY[a.id].title.localeCompare(CATEGORY[b.id].title));
