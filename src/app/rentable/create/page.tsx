...
const RentableCreate = () => {
  ...
  const [billingFrequency, setBillingFrequency] =
    useState<RentableBillingFrequencyEnum>("NEGOTIABLE");
    ...
    try {
      if (auth) {
        ...
        const body: Rentable = {
          ...
          type: data.category.toUpperCase() as RentableTypeEnum,
          place: data.place,
      ...
      <div className="flex justify-center gap-5 mt-4">
        ...
        {step < steps.length - 1 ? (
          ...
          <button
            ...
            className="px-4 py-2 border-none bg-green-500 hover:bg-green-400 rounded-md text-white"
          >
            Enviar
          </button>
        )}
